  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addBooking({
        ...
        dpPaidAt: new Date(`${bookingDate}T${startTime}:00+07:00`).toISOString(),
        dpCashier: cashierName.trim() || 'Owner',
        settlementAmount: isLunas ? finalAmountPaid : undefined,
        settlementPaymentMethod: isLunas ? paymentMethod : undefined,
        settlementPaidAt: isLunas ? new Date(`${bookingDate}T${startTime}:00+07:00`).toISOString() : undefined,
